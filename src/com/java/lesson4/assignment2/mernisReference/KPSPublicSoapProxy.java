...
public class KPSPublicSoapProxy implements com.java.lesson4.assignment2.mernisReference.KPSPublicSoap {
  private String _endpoint = null;
  private com.java.lesson4.assignment2.mernisReference.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new com.java.lesson4.assignment2.mernisReference.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public com.java.lesson4.assignment2.mernisReference.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
