...
package com.java.lesson4.assignment2.mernisReference;

public class KPSPublicLocator extends org.apache.axis.client.Service implements com.java.lesson4.assignment2.mernisReference.KPSPublic {
    ...
    public com.java.lesson4.assignment2.mernisReference.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.java.lesson4.assignment2.mernisReference.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.java.lesson4.assignment2.mernisReference.KPSPublicSoapStub _stub = new com.java.lesson4.assignment2.mernisReference.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.java.lesson4.assignment2.mernisReference.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.java.lesson4.assignment2.mernisReference.KPSPublicSoapStub _stub = new com.java.lesson4.assignment2.mernisReference.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
